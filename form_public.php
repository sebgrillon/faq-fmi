...
else
{
	...
	if(isset($_POST['cdg'])) {
		$cdg = $_POST['cdg'];
			...
			$cdg = '';
			$incomplet .= 'Gestionnaire de la compétition obligatoire. ';
		}
	if(isset($_POST['categorie'])) {
		$categorie = $_POST['categorie'];
			...
			$categorie = '';
			$incomplet .= 'Catégorie obligatoire. ';
		}
	if(isset($_POST['division'])) {
		$division = $_POST['division'];
			...
			$division = '';
			$incomplet .= 'Compétition obligatoire. ';
		}
	...
	if(isset($_POST['support'])) {
		$support = $_POST['support'];
			...
			$support = '';
			$incomplet .= 'Précision du support obligatoire. ';
		}
	...
	if(isset($_POST['descriptif'])) {
		$descriptif = $_POST['descriptif'];
			...
			$descriptif = '';
			$incomplet .= 'Description du problème obligatoire. ';
		}
